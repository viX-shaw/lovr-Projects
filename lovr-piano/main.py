...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--port", type=int, default=5015, help="The port the OSC server is listening on"
    )
    args = parser.parse_args()
    osc_client = udp_client.SimpleUDPClient(args.ip, args.port)
    osc_client2 = udp_client.SimpleUDPClient(args.ip, 5016)
    osc_client3 = udp_client.SimpleUDPClient(args.ip, 5017)
